...
const DesktopSidebar: React.FC<DesktopSidebarProps> = ({ currentUser }) => {
  ...
  return (
    <>
      ...
      />
      <div className='hidden lg:fixed lg:inset-y-0 lg:left-0 lg:z-40 lg:w-20 lg:overflow-y-auto lg:border-r-[1px] lg:pb-4 lg:flex lg:flex-col justify-between'>
        <nav className='flex flex-col justify-between mt-4 w-full h-full items-center'>
          ...
          >
            <Avatar user={currentUser} includeName={true}/>
          </div>
        </nav>
      </div>
    </>
